...
const createFlight = asyncWrapper(
  async (req, res, next) => {
    try {
      ...
      if (!flightData.from || !flightData.distination || !flightData.departureDate || !flightData.arrivalDate || !flightData.price || !flightData.busSeats || !flightData.ecoSeats ||!flightData.abbreviationDistination ||!flightData.abbreviationFrom ) {
